import thing from "/soggle/assets/words.json" with { type: "json" };
...
const YIPPEEE = new Audio("soggle/assets/sounds/confetti.mp3");
YIPPEEE.volume = 1.0;
...
async function generateSogs(the_image, soggy) {
  for (let i = 0; i < 500; i++) {
    ...
    if (soggy) {
      const MEOW = new Audio("soggle/assets/sounds/meow.flac");
